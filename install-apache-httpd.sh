...
./configure --prefix=/opt/apache-httpd/lib/apr-util --with-apr=/opt/apache-httpd/lib/apr --with-expat=/opt/apache-httpd/lib/expat-2.6.3 --with-crypto
make
make install
...
./configure --prefix=/opt/apache-httpd/httpd-2.4.62 --with-apr=/opt/apache-httpd/lib/apr --with-apr-util=/opt/apache-httpd/lib/apr-util --with-expat=/opt/apache-httpd/lib/expat-2.6.3 --with-pcre=/opt/apache-httpd/lib/pcre2-10.44
make
make install
