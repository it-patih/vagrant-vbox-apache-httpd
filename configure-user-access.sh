...
echo "> Create a new user apache"
sudo useradd -m -s /bin/bash apache

echo "> Backup /home/apache/.ssh/authorized_keys"
sudo cp /home/apache/.ssh/authorized_keys /home/apache/.ssh/authorized_keys.$NOW
sudo chown apache:apache /home/apache/.ssh/authorized_keys.$NOW

echo "> Configure ssh from user vagrant to user apache"
